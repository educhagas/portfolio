//
// Created by eduar on 03/07/2022.
//
...
#include "portfolio/spea2_algorithm.h"
int main() {
    ...
    for (size_t i = 0; i < 1; ++i) { // 100
        ...
        portfolio::spea2_algorithm solver(prob);
        ...
        //            fout << p.first.values()[0] << " ; " <<
        //            p.first.values()[1] << "\n";
        //            pareto_front_result.insert(std::make_pair(
        //                pareto::front<double, 2,
        //                portfolio::portfolio>::key_type(
